...
<head>
  ...
  <title>Asta98 Restaurant - Drink</title>
...
<body>
        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
                <li class="nav-item"><a class="nav-link" href="/">Bebek</a></li>
                <li class="nav-item"><a class="nav-link" href="#">Minum</a></li>
  ...
  <section class="hero-banner">
    <div class="hero-wrapper">
      <div class="hero-left">
        <h1 class="price-tag price-bold">Asta98 <br> Restaurant <br></h1><h3>Nikmati-Sensasi-Lesehan</h3>
  ...
  <!--================Drink menu section start =================--> 
  <section class="section-margin">
    <div class="container">
      <div class="section-intro mb-75px">
        <h4 class="intro-title">Daftar Minum</h4>
        <h2>Segar & Hangat</h2>
      </div>
